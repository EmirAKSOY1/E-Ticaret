...
include("db.php");
      $sec= "SELECT product_id , product_name , product_detail , product_price , product_image FROM product WHERE category_id=$kategori_id ORDER BY product_id  LIMIT $limit,$listelenecek";
